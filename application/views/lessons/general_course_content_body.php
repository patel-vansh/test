<div class="col-lg-9 order-1 course_col" id = "video_player_area">
    ...
    <?php else: ?>
        <div class="text-center" style="margin-top: 150px">
            <h5 class="card-title w-100 mb-3">To view this content, download Flexy Teacher app from Google play store.</h5>
            <button class="download-app-btn" type="button" id="download-app-from-play-store" onclick="window.open('https://play.google.com/store/apps/details?id=com.flexyteacher.flexyteacher', '_blank').focus();"><?php echo site_phrase('download_now'); ?></button>
        </div>
    <?php endif; ?>
</div>
<style>
