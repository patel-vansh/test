			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="w-100 d-grid">
						...
						<?php $counter = 0 ?>
						<?php foreach ($this->crud_model->getCartItems() as $cart_item) :
							$counter++;
						...
						<?php endforeach; ?>
						<?php foreach ($this->crud_model->getCartBundleItems() as $cart_item) :
							$counter++;
							...
							<p class="item float-start">
								<span class="count-item"><?php echo $counter; ?></span>
								<span class="item-title"><?php echo $bundle_details['title']; ?>
									<span class="item-price">
