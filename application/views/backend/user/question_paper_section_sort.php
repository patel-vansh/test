<?php
$sections_id = json_decode($this->crud_model->get_question_paper_sections($param2)->result_array()[0]['sections_id']);
$sections = array();
                                            ...
                                            <div class="card-body">
                                                <div class="media">
                                                    <div class="media-body">
                                                        <h5 class="mb-1 mt-0"><?php echo $section['name']; ?></h5>
                                                    </div> <!-- end media-body -->
                                                </div> <!-- end media -->
                                            </div> <!-- end card-body -->
                                        </div> <!-- end col -->
...
<script type="text/javascript">
    function sort() {
        ...
        $.ajax({
            url: '<?php echo site_url('user/ajax_sort_question_paper_section/');?>',
            type : 'POST',
