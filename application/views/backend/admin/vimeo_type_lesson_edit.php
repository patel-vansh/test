...
<div class="form-group">
    ...
    <select class="form-control"   name="lesson_provider_for_mobile_application" id="lesson_provider_for_mobile_application">
        <option value="html5" <?php if(strtolower($lesson_details['video_type_for_mobile_application']) == 'html5') echo 'selected'; ?>>HTML5</option>
        <option value="youtube" <?php if(strtolower($lesson_details['video_type_for_mobile_application']) == 'youtube') echo 'selected'; ?>>Youtube</option>
        <option value="vimeo" <?php if(strtolower($lesson_details['video_type_for_mobile_application']) == 'vimeo') echo 'selected'; ?>>Vimeo</option>
    </select>
</div>
