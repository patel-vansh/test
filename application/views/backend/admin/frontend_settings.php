        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="insta"><?php echo get_phrase('instagram'); ?></label>
                        <input type="text" name = "insta" id = "insta" class="form-control" value="<?php echo get_frontend_settings('instagram');  ?>">
                    </div>
                    
                    <div class="form-group">
                        <label for="youtube"><?php echo get_phrase('youtube'); ?></label>
                        <input type="text" name = "youtube" id = "youtube" class="form-control" value="<?php echo get_frontend_settings('youtube');  ?>">
                    </div>
