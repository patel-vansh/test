						...
						?>
		                    ...
		                    <li class="clearfix <?php if($first_sender != $sender_id )echo 'odd'; ?>">
		                        ...
		                        <div class="conversation-text">
                                    ...
                                    <small class="message_sending_time"><?php
                                    date_default_timezone_set('Asia/Kolkata');
                                    echo date("d M, Y H:i A" , $row['timestamp']);?></small>
		                        </div>
		                    </li>
	                    <?php endforeach;?>
	                </ul>
