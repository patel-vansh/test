                      ...
                      <table class="table table-striped table-centered mb-0">
                          <thead>
                              <tr>
                                  ...
                                  <th><?php echo get_phrase('enrolled_course_bundle'); ?></th>
                          ...
                          <tbody>
                            <?php
                                foreach ($enrol_history['result_array'] as $enrol):
                                    ...
                                    if ($enrol['transaction_id']) {
                                        $course_data = $this->db->get_where('course_bundle', array('id' => $enrol['bundle_id']))->row_array();
                                    } else {
                                    ...
                                    <tr class="gradeU">
                                        ...
                                        if ($enrol['transaction_id']) {
                                            echo site_url('addons/bundle/edit_bundle_form/'.$course_data['id']);
                                        } else {
                                            echo site_url('admin/course_form/course_edit/'.$course_data['id']);
                                        }?>" target="_blank"><?php if ($enrol['transaction_id']) {
                                            echo $course_data['title'] . " (Bundle)";
                                        } else {
                                            echo $course_data['title'] . " (Course)";
                                        } ?></a></strong></td>
