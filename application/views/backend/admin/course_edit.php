                                    ...
                                    <div class="tab-pane" id="basic">
                                        <div class="row justify-content-center">
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="subscription_limit"><?php echo get_phrase('subscription_limit'); ?></label>
                                                    <div class="col-md-10">
                                                        <input type="number"  name="subscription_limit" id = "subscription_limit" class="form-control" value="<?php echo $course_details['subscription_limit']; ?>" > 
                                                    </div>
                                                </div>
