    ...
    <div class="row mb-3">
      ...
      <div class="col-12 col-xl-5 order-md-first pe-4 pe-xl-5 ps-4 ps-xl-0">
        ...
        <ul class="footer-social-link">
          ...
          <?php $insta = get_frontend_settings('instagram'); ?>
          <?php $youtube = get_frontend_settings('youtube'); ?>
          <?php if($facebook): ?>
            <li class="mb-1 mt-2">
    ...
    <div class="container-xl">
      <div class="row mt-3 py-1">
        <div class="col-md-4 ps-4 ps-md-1">
          <a href="<?php echo site_url(); ?>"><img src="<?php echo base_url('uploads/system/'.get_frontend_settings('light_logo')); ?>" width="160"></a>
        </div>
        <div class="col-md-4 ps-4 text-13px pt-2 text-start text-md-center">
          &copy; <?php echo date("Y") . " " .  get_settings('system_name'); ?>, <?php echo site_phrase('all_rights_reserved'); ?>
          <br>
