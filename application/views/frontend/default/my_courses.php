...
<?php
    $my_courses1 = $this->user_model->my_courses()->result_array();
    $my_courses2 = $this->user_model->my_courses_trash()->result_array();
    $my_courses = array_merge($my_courses1,$my_courses2);

    $categories = array();
    foreach ($_my_courses as $my_course) {
