            ...
            <div class="course-curriculum-accordion">
              ...
              foreach ($sections as $key => $section) : ?>
                <div class="lecture-group-wrapper">
                  ...
                  <div class="lecture-group-title clearfix" style="<?= $style; ?>" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $section['id']; ?>" aria-expanded="<?php if ($counter == 0) echo 'true'; else echo 'false'; ?>">
        ...
        <div class="course-sidebar box-shadow-5 natural">
          ...
          <div class="course-sidebar-text-box">
            <div class="subscription text-center">
                <a class="badge-sub-warning text-decoration-none fw-600 hover-shadow-1 d-inline-block" style="margin-bottom: 10px;"></i><span style="color: #cc7a1c;font-weight: bold">Subscription </span> - <?php echo $course_details['subscription_limit']; ?> Days</a>
            </div>
            ...
            <?php if (is_purchased($course_details['id']) || in_array($course_details['id'], $final_courses_id)) : ?>
              <div class="already_purchased">
                <a class="btn btn-buy-now active" href="<?php
                if (in_array($course_details['id'], $final_courses_id)) {
                    echo site_url('home/my_bundles');
                }
                else {
                    echo site_url('home/my_courses');
                }?>"><?php echo site_phrase('already_purchased'); ?></a>
              </div>
            <?php else : ?>
              ...
              <?php else : ?>
                <div class="buy-btns">
                  <?php if (in_array($course_details['id'], $this->crud_model->getCartItems())) : ?>
