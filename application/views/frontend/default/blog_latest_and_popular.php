                            ...
                            <div class="card radius-10">
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <!--<a href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>"><?php echo $latest_blog['title']; ?></a>-->
                                        <p style="line-height: 30px; margin-top: 15px; font-weight: 500" class="card-text ellipsis-line-2">
                                            <?php echo strip_tags(htmlspecialchars_decode($latest_blog['title'])); ?>
                                        </p>
                                    </font>
                                    <font face="Rasa" size="4px">
                                        <p style="line-height: 20px; margin-top: 5px;" class="card-text ellipsis-line-3">
                                            <?php echo strip_tags(htmlspecialchars_decode($latest_blog['description'])); ?>
                                        </p>
                                    </font>
                                    
                                    <a class="btn btn-outline-info" style="margin-top: 10px;" href="<?php echo site_url('blog/details/'.slugify($latest_blog['title']).'/'.$latest_blog['blog_id']); ?>"><?php echo site_phrase('read_more'); ?></a>
                        ...
                        <?php foreach($popular_blogs->result_array() as $popular_blog): ?>
                            ...
                            <div class="col">
                                <div class="card radius-10">
                                    ...
                                    <?php if(file_exists($blog_thumbnail) && is_file($blog_thumbnail)): ?>
                                        <img src="<?php echo base_url($blog_thumbnail); ?>" class="card-img-top radius-top-10" alt="<?php echo $popular_blog['title']; ?>">
                                    <?php else: ?>
                                        <img src="<?php echo base_url('uploads/blog/thumbnail/placeholder.png'); ?>" class="card-img-top radius-top-10" alt="<?php echo $popular_blog['title']; ?>">
                                    <?php endif; ?>
                                    <div class="card-body pt-4">
                                        <p class="card-text">
                                        ...
                                        <font face="Rasa" size="5px">
                                            <!--<a href="<?php echo site_url('blog/details/'.slugify($popular_blog['title']).'/'.$popular_blog['blog_id']); ?>"><?php echo $popular_blog['title']; ?></a>-->
                                            <p style="line-height: 30px; margin-top: 15px; font-weight: 500" class="card-text ellipsis-line-2">
                                                <?php echo strip_tags(htmlspecialchars_decode($popular_blog['title'])); ?>
                                            </p>
                                        </font>
                                        <font face="Rasa" size="4px">
                                            <p style="line-height: 20px; margin-top: 5px;" class="card-text ellipsis-line-3">
                                        ...
                                        <a class="btn btn-outline-info" style="margin-top: 10px;" href="<?php echo site_url('blog/details/'.slugify($popular_blog['title']).'/'.$popular_blog['blog_id']); ?>"><?php echo site_phrase('read_more'); ?></a>
