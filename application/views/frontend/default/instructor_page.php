    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-xl-3 order-first order-lg-last text-center">
                <a href="<?php echo site_url('home/instructor_page/' . $instructor_id); ?>"><img class="radius-10" src="<?php echo $this->user_model->get_user_image_url($instructor_details['id']);?>" alt="" class="img-fluid" style="max-width: 300px;"></a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="col-lg-12 col-xl-10">
            ...
            <div class="course-carousel">
                ...
                foreach ($course_ids as $course_id) :
                    ...
                    ?>
                    <?php if ($top_course['status'] == "active"): ?>
