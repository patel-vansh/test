...
<?php foreach ($my_courses as $my_course):
                ...
                if($my_course['expired']=='1')
                {
                    $expired = "style='pointer-events: none;'";
                    $div = "";
                    $status_c = "Expired";
                    $status_cc = "Expired";
                    $status_c_style = "danger";
                    $e_date = $my_course['created'];
                    
                }
                else
                {
                    $c_id = $my_course['course_id'];
                    ...
                    $e_date = date('Y-m-d', strtotime($subscription_limit, strtotime($my_course['created'])));
                    
                    $status_cc = "Expire";
                    $expired = '';
                    $div='';
                    $status_c = "Active";
                    $status_c_style = "success";
    ...
    <div class="course-box">
      ...
      <div class="pb-3" id = "course_info_view_<?php echo $course_details['id'];  ?>">
        ...
        <div class="row row-no-gutters">
            <div class="col-sm-6">
                <div class="statusdiv w-100 pb-2">
                    <div class="status text-muted float-left w-100">
                        Status : 
                        <span class="badge bg-<?php echo $status_c_style?>"><?php echo $status_c; ?></span> 
                    </div>
                    <span class="expire-date mini-text" style="color: #696969">
                    <?php $expire_date = strtotime($e_date); ?>
                    <?php echo $status_cc; ?> on <?php echo date('d M Y', $expire_date); ?>                      
                    </span>
                </div>
            </div>
            <div class="col-sm-5">
