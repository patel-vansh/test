                        ...
                        <div class="col">
                            <div class="card radius-10">
                                ...
                                <div class="card-body pt-4">
                                    ...
                                    <!--<a href="<?php echo site_url('blog/details/'.slugify($blog['title']).'/'.$blog['blog_id']); ?>"><?php echo $blog['title']; ?></a>-->
                                        <p style="line-height: 30px; margin-top: 15px; font-weight: 500" class="card-text ellipsis-line-2">
                                            <?php echo strip_tags(htmlspecialchars_decode($blog['title'])); ?>
                                        </p>
                                    </font>
                                    ...
                                    <a class="btn btn-outline-info" style="margin-top: 10px;" href="<?php echo site_url('blog/details/'.slugify($blog['title']).'/'.$blog['blog_id']); ?>"><?php echo site_phrase('read_more'); ?></a>
