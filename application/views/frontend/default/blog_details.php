        ...
        <div class="row">
            <div class="col-lg-9">
                <div class="row">
                	...
                	<div class="col-md-12">
                		<font face="Rasa" size="10px;" color="#153466"><h1 class="display-6 mt-4 fw-500"><?php echo $blog_details['title']; ?></h1></font>
                	</div>

                	<div class="col-md-12">
                		<font face="Rasa" size="5px;"><p class="display-7 fw-400"><?php echo strip_tags(htmlspecialchars_decode($blog_details['description'])); ?></p></font>
                	</div>
