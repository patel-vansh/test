...
$route['course_bundles/search/(:any)/(:any)']                = "addons/course_bundles/search/$1/$2";
$route['bundle_details/(:any)/(:any)']                      = "addons/course_bundles/bundle_details/$1/$2";
$route['bundle_details/(:any)']                              = "addons/course_bundles/bundle_details/$1";
